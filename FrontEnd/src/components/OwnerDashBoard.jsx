  ...
  return (
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
      ...
      <><div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
                  ...
                  <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'><FaUtensils className='text-[#ff4d2d] w-14 h-14 ' />Welcome {myShopData.shop.name}</h1>
                  <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
                    ...
                    {myShopData.shop.address && <p className='text-gray-500 mb-4' >{myShopData.shop.address}</p>}
                  </div>
                  </div>
                  
        </div></>
      }
      {myShopData?.shop.items.length===0 && <div className='flex justify-center items-center p-4 sm:p-6'> 
      <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
        <div className='flex flex-col items-center text-center'>
          <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4' />
      ...
      {myShopData?.shop.items.length>0 &&
       <div className='flex flex-col items-center gap-4 w-full max-w-3xl' > {myShopData?.shop.items.map((item,index)=>(
